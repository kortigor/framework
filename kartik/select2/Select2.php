...
/**
 * Select2 widget is a wrapper for the Select2 jQuery plugin. This input widget is a jQuery based replacement for
 * select boxes. It supports searching, remote data sets, and infinite scrolling of results. The widget is specially
 * styled for Bootstrap 3.x (deprecated) and Bootstrap 4.x.
 *
...
class Select2 extends InputWidget
{
     ...
     * - [[THEME_KRAJEE_BS4]] for Bootstrap version '4.x'
     */
    public string $theme;
     ...
     */
    public string|array $initValueText;
    ...
    /**
     * @var bool whether to hide the search control and render it as a simple select.
     */
     ...
     */
    public array $toggleAllSettings = [];
     ...
     */
    protected string $_s2OptionsVar;
    ...
    protected function renderToggleAll()
    {
        ...
        $settings = array_replace_recursive([
            'selectLabel' => $unchecked . t('Выбрать все'),
            'unselectLabel' => $checked . t('Очистить все'),
            'selectOptions' => [],
            'unselectOptions' => [],
