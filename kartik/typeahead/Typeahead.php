...
/**
 * Typeahead widget is a wrapper for the Twitter typeahead.js plugin. This
 ...
 * @see https://demosbs3.krajee.com/widget-details/typeahead
 */
class Typeahead extends TypeaheadBasic
{
     ...
     * Defaults to `true`.
     */
    public bool $useHandleBars = true;
     ...
     */
    public array $defaultSuggestions = [];
     ...
     */
    protected bool $_defaultSuggest = false;
