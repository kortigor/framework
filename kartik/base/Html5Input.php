...
class Html5Input extends InputWidget
{
    ...
    /**
     * @var string the message shown for unsupported browser. If not set will not be displayed.
     */
     ...
     */
    private static array $_allowedInputTypes = [
        'color',
        'range',
        'text',
        'hidden',
    ...
    protected function renderInput()
    {
        ...
        if (!isset($this->noSupport)) {
            ...
            $noSupport = !empty($this->noSupport)
                ? $this->noSupport
                : 'It is recommended you use an upgraded browser to display the ' . $this->type . ' control properly.';
