...
/**
 * Switch widget is a wrapper for the Bootstrap Switch plugin by Mattia, Peter, & Emanuele. This input widget is a
...
class SwitchInput extends InputWidget
{
     ...
     */
    public int $type = self::CHECKBOX;

    /**
     * @var bool whether to enable third indeterminate behavior when type is `SwitchInput::CHECKBOX`. Defaults to
     *     `false`.
     */
     ...
     *     Defaults to `null`.
     */
    public ?string $indeterminateValue = null;
     ...
     */
    public array $indeterminateToggle = [];
     ...
     */
    public array $containerOptions = ['class' => 'form-group'];

    /**
     * @inheritdoc
     */
    public string $pluginName = 'bootstrapSwitch';
