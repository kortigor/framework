...
(function($)
{
    ...
    var MagicSuggest = function(element, options)
    {
        ...
        var defaults = {
             ...
             */
            emptyText: function() {
                return cfg.editable ? 'Введите теги' : 'Click here';
            },
            ...
            maxSelectionRenderer: function(v) {
                return 'Нельзя выбрать более ' + v + ' тегов' + (v > 1 ? 's':'');
            },
        ...
        var handlers = {
            ...
            _onKeyDown: function(e) {
                ...
                switch(e.keyCode) {
                    ...
                    case 188: // esc
                    case 13: // enter
 //                       e.preventDefault(); //hacking problem with russian Р‘
                        break;
                    case 17: // ctrl
                        _ctrlDown = true;
                        break;
