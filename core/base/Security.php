 ...
 * for encryption/decryption on all platforms.
 *
...
class Security
{
     ...
     *
     * > Note: Application encryption protocol uses the same size for cipher key, HMAC signature key and key
     * derivation salt.
     */
     ...
     */
    public int $derivationIterations = 100000;
    /**
     ...
     * $hash = Sys::$app->getSecurity()->generatePasswordHash($password);
     * // ...save $hash in database...
     *
     * // during login, validate if the password entered is correct using $hash fetched from database
     * if (Sys::$app->getSecurity()->validatePassword($password, $hash)) {
     *     // password is good
     * } else {
     *     // password is bad
     * }
     ...
     */
    public function compareString(string $expected, string $actual)
    {
