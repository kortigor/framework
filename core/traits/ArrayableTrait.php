...
use core\link\HalSerializer;
use core\interfaces\ArrayableInterface;
use Psr\Link\LinkProviderInterface;

/**
 * ArrayableTrait provides a common implementation of the `ArrayableInterface` interface.
 *
...
trait ArrayableTrait
{
    ...
    public function toArray(array $fields = [], array $expand = [], bool $recursive = true): array
    {
        ...
        if ($this instanceof LinkProviderInterface) {
            $data['_links'] = (new HalSerializer)->serialize($this->getLinks());
        }
