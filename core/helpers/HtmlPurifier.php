...
class HtmlPurifier
{
     ...
     */
    public static function process(string $content, array|Closure|null $config = null)
    {
        $configInstance = \HTMLPurifier_Config::create($config instanceof Closure ? null : $config);
        $configInstance->autoFinalize = false;
        $purifier = \HTMLPurifier::instance($configInstance);
        $purifier->config->set('Cache.SerializerPath', Sys::$app->runtimePath());
     ...
     */
    protected static function configure(\HTMLPurifier_Config $config)
    {
    }
}
