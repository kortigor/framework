...
class Json
{
     ...
     * represented in terms of a `\core\activeform\JsExpression` object.
     *
    ...
    public static function htmlEncode($value): string
    {
        return static::encode(
            $value,
            JSON_UNESCAPED_UNICODE | JSON_HEX_QUOT | JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_PRETTY_PRINT
        );
    }
     ...
     * @param ModelValidableInterface|ModelValidableInterface[] $models the model(s) whose validation errors are to be displayed.
