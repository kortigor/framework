...
class Accordion extends Widget
{
     ...
     *
     * You may also specify this property as key-value pairs, where the key refers to the
     ...
     * @throws \Exception if label isn't specified
    ...
    public function renderItem($header, $item, $index)
    {
        if (array_key_exists('content', $item)) {
            ...
            if (is_string($item['content']) || is_numeric($item['content']) || is_object($item['content'])) {
                ...
                throw new \Exception('The "content" option should be a string, array or object.');
            }
        } else {
            throw new \Exception('The "content" option is required.');
        }
        $group = [];
