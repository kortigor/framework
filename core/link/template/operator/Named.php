...
class Named extends Abstraction
{
    ...
    public function expandString(Parser $parser, Variable $var, string $val): string
    {
        ...
        if ($var->modifier === ':') {
            $val = mb_substr($val, 0, (int) $var->value);
        }
    ...
    public function extract(Parser $parser, Variable $var, string $data): string|array
    {
        ...
        switch ($var->modifier) {
            ...
            default:
                ...
                $value = str_replace($var->getToken() . '=', '', $data);
     ...
     * @return string
     */
    public function encodeExplodeVars(Parser $parser, Variable $var, array|object $data): string
    {
