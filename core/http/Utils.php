...
final class Utils
{
     ...
     */
    public static function normalizeHeader($header): array
    {
        if (!is_array($header)) {
     ...
     * to encode using RFC3986, or PHP_QUERY_RFC1738 to encode using RFC1738.
     */
     ...
     */
    public static function getMessageBodySummary(MessageInterface $message, int $truncateAt = 120): ?string
    {
        $body = $message->getBody();
     ...
     * @internal
     */
    private static function parseRequestUri(string $path, array $headers): string
    {
    ...
    /** @internal */
    private static function caselessRemove(array $keys, array $data): array
    {
        $result = [];
