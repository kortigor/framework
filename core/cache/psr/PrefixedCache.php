...
/**
 * PrefixedCache decorates any PSR-16 cache to add global prefix.
 * It is added to every cache key so that it is unique globally in the whole cache storage.
 * It is recommended that you set a unique cache key prefix for each application
