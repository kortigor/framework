 ...
 *
 * Child classes should override its for generating the actual dependency data.
 * 
 * @see generateDependencyData()
 */
abstract class Dependency
{
    ...
    /**
     * @var array<string, mixed> Static storage of cached data for reusable dependencies.
     */
