 ...
 *         ]],
 *         ['label' => 'Login', 'url' => ['site/login'], 'visible' => Sys::$app->user->isGuest],
 *     ],
 * ]);
 * ```
 *
 * @author Qiang Xue <qiang.xue@gmail.com> & Igor Kort <kort.igor@gmail.com>
 */
class Menu extends Widget
{
     ...
     * - icon: string, optional, specifies the menu item icon. When [[encodeLabels]] is true, the icon
     *   will be HTML-encoded. If the icon is not specified, an empty string will be used.
     ...
     * while `{label}` and `{icon}` will be replaced with the link text.
     * This property will be overridden by the `template` option set in individual menu items via [[items]].
     */
    public string $linkTemplate = '<a href="{url}">{icon}{label}</a>';

    /**
     * @var string the template used to render the body of a menu which is NOT a link.
     * In this template, the token `{label}` and `{icon}` will be replaced with the label of the menu item.
     * This property will be overridden by the `template` option set in individual menu items via [[items]].
     */
