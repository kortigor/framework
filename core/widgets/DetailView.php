...
class DetailView extends Widget
{
     ...
     * an associative array, an object that implements [[ArrayableInterface]] interface or simply an object with defined
     ...
     *   Please refer to [[\core\helpers\Html::renderTagAttributes()]] for the supported syntax.
     ...
     *
     * The tokens `{captionOptions}` and `{contentOptions}` are available, which will represent
     * HTML attributes of HTML container elements for the label and value.
     */
    public string $template = '<tr><th{captionOptions}>{label}</th><td{contentOptions}>{value}</td></tr>';
    /**
    ...
    public function init()
    {
        ...
        if (!isset($this->formatter)) {
            ...
            $this->formatter = new Formatter($this->formatter);
        }
    ...
    protected function normalizeAttributes()
    {
        if ($this->attributes === null) {
            if ($this->model instanceof Model) {
                ...
                $this->attributes = $this->model instanceof ArrayableInterface || $this->model instanceof ActiveRecord ?
        ...
        foreach ($this->attributes as $i => $attribute) {
            ...
            if (isset($attribute['attribute'])) {
                ...
                if (!isset($attribute['label'])) {
                    $attribute['label'] = $this->model instanceof Model || $this->model instanceof ActiveRecord ?
