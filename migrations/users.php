...
Capsule::schema()->create($tableName, function (Blueprint $table) {
    ...
    $table->string('auth_key')->comment('Auth key for "remember me"');
    $table->string('verification_token')->comment('Email verification token');
...
\common\models\User::insert(
    [
        [
            'id' => \core\entities\Id::next()->getId(),
            'username' => 'admin',
            'fullname' => 'Администратор Сайта',
            'email' => 'info@biomer.ru',
            'birthdate' => '1990-01-01',
            'status' => \customer\entities\StatusEmployee::STATUS_ACTIVE,
            'role' => \customer\entities\EmployeeRole::CONTENT_MANAGER,
            'password' => password_hash('qwertyuiop', PASSWORD_BCRYPT),
...
echo sprintf('Table "%s" filled successfully', $tableName) . "\n";
